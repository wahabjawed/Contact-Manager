...
<!--[if lt IE 9]>
	...
	function AddContactInfoBar(){
		...
		contactInfoBar += '<td style="width:35%" ><div class="form-group" Style="margin-left:0px;margin-right:5px;"><label for="inputContactType'+contactInfoBarCounter+'" >Type</label><select class="form-control" id="inputContactType'+contactInfoBarCounter+'" name="inputContactType'+contactInfoBarCounter+'" required ><?PHP FillContactInfoTypeCombo(0); ?></select></div></td>';
        contactInfoBar += '<td style="width:60%" ><div class="form-group" Style="margin-left:5px;margin-right:5px;"><label for="inputContactInfo'+contactInfoBarCounter+'" >Value</label><input type="text" class="form-control" id="inputContactInfo'+contactInfoBarCounter+'" name="inputContactInfo'+contactInfoBarCounter+'" placeholder="Value" required ></div></td>';
      ...
      <div class="panel panel-default">
        ...
        <div class="panel-body">
          <div class="form-group">
            ...
            <div class="col-sm-10">
              <select class="form-control" id="inputTitle" name="inputTitle" required >
          ...
          <div class="form-group">
            ...
            <div class="col-sm-10">
              <input type="text" class="form-control" id="inputFirstName" name="inputFirstName" placeholder="First Name" value="<?PHP echo $FirstName; ?>" required >
            </div>
          </div>
          <div class="form-group">
          ...
          <div class="form-group">
            ...
            <div class="col-sm-10">
              <input type="text" class="form-control" id="inputLastName" name="inputLastName" placeholder="Last Name" value="<?PHP echo $LastName; ?>"  required >
            </div>
          </div>
          <div class="form-group">
            <label for="inputAddress" class="col-sm-2 control-label">Address</label>
            <div class="col-sm-10">
              <input type="text" class="form-control" id="inputAddress" name="inputAddress" placeholder="Address"  value="<?PHP echo $Address; ?>"  required >
            </div>
          </div>
          ...
          <div class="form-group">
            ...
            <div class="col-sm-10" style="height:35px;" >
              <select class="form-control" onchange="document.getElementById('inputCountry').value=this.options[this.selectedIndex].value; FillStateCombo();">
				<option value="">Select Country</option>
				<?PHP FillCountryCombo(); ?>
              </select>
              <input type="text" class="form-control" id="inputCountry" name="inputCountry" placeholder="Country"  style="position:relative;top:-34px;width:92%" onfocus="this.select()"  value="<?PHP echo $Country; ?>" required >
            </div>
          </div>
          <div class="form-group">
            <label for="inputState" class="col-sm-2 control-label">State</label>
            <div class="col-sm-10" style="height:35px;">
            <select class="form-control" id="selectState" onchange="document.getElementById('inputState').value=this.options[this.selectedIndex].value; FillCityCombo();">
                
              </select>
              <input type="text" class="form-control" id="inputState" name="inputState" placeholder="State" style="position:relative;top:-34px;width:92%" onfocus="this.select()"  value="<?PHP echo $State; ?>" required >
            </div>
          </div>
          <div class="form-group">
            <label for="inputCity" class="col-sm-2 control-label">City</label>
            <div class="col-sm-10" style="height:35px;">
              <select class="form-control" id="selectCity" onchange="document.getElementById('inputCity').value=this.options[this.selectedIndex].value;">
              </select>
              <input type="text" class="form-control" id="inputCity" name="inputCity" placeholder="City" style="position:relative;top:-34px;width:92%" onfocus="this.select()"  value="<?PHP echo $City; ?>" required >
            </div>
          </div>
      ...
      <div class="panel panel-default">
        ...
        <div class="panel-body"> 
         ...
         <div class="form-group">
            ...
            <div class="col-sm-10">
              <select class="form-control" id="inputCompany" name="inputCompany" required >
         ...
         <div class="form-group" >
            ...
            <div class="col-sm-10" style="height:35px;">
              ...
              <input type="text" class="form-control" id="inputDepartment" name="inputDepartment" placeholder="Department"  style="position:relative;top:-34px;width:92%" onfocus="this.select()"  value="<?PHP echo $Department; ?>" required >
            </div>
          </div>
         ...
         <div class="form-group" >
            ...
            <div class="col-sm-10" style="height:35px;">
              ...
              <input type="text" class="form-control" id="inputDesignation" name="inputDesignation" placeholder="Designation"  style="position:relative;top:-34px;width:92%" onfocus="this.select()"  value="<?PHP echo $Designation; ?>" required >
            </div>
          </div>
        ...
        <input type="number" value="<?PHP echo --$ContactInfoBarCount ;?>" id="contactInfoBarCounter" name="contactInfoBarCounter" style="visibility:hidden;"/>
          ...
          <?PHP 
				...
				while ($row = $sth->fetch(PDO::FETCH_ORI_NEXT)) {
					...
					echo '<select class="form-control" id="inputContactType'.$i.'" name="inputContactType'.$i.'" required >';
					...
					echo '<input type="text" class="form-control" id="inputContactInfo'.$i.'" name="inputContactInfo'.$i.'" placeholder="Value" value="'.$row['Value'].'" required >';
					echo '</div></td>';
