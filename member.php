        ...
        <div class="panel-body">
          ...
          <div class="form-group">
            ...
            <div class="col-sm-10" style="height:35px;" >
              ...
              <input type="text" class="form-control" id="inputCountry" name="inputCountry" placeholder="Country"  style="position:relative;top:-34px;width:92%" onfocus="this.select()" required >
            </div>
          </div>
          <div class="form-group">
            ...
            <select class="form-control" id="selectState" onchange="document.getElementById('inputState').value=this.options[this.selectedIndex].value; FillCityCombo();">
              ...
              <input type="text" class="form-control" id="inputState" name="inputState" placeholder="State" style="position:relative;top:-34px;width:92%" onfocus="this.select()" required >
            </div>
          </div>
          <div class="form-group">
            ...
            <div class="col-sm-10" style="height:35px;">
              ...
              <input type="text" class="form-control" id="inputCity" name="inputCity" placeholder="City" style="position:relative;top:-34px;width:92%" onfocus="this.select()" required >
            </div>
          </div>
        ...
        <div class="panel-body"> 
         ...
         <div class="form-group" >
            ...
            <div class="col-sm-10" style="height:35px;">
              ...
              <input type="text" class="form-control" id="inputDepartment" name="inputDepartment" placeholder="Department"  style="position:relative;top:-34px;width:92%" onfocus="this.select()" required >
            </div>
          </div>
         ...
         <div class="form-group" >
            ...
            <div class="col-sm-10" style="height:35px;">
              ...
              <input type="text" class="form-control" id="inputDesignation" name="inputDesignation" placeholder="Designation"  style="position:relative;top:-34px;width:92%" onfocus="this.select()" required >
            </div>
          </div>
          ...
          <table width="100%" id="contactInfoTable">
            <tr>
              <td style="width:35%" ><div class="form-group" Style="margin-left:0px;margin-right:5px;">
                  ...
                  <select class="form-control" id="inputContactType0" name="inputContactType0" required >
              ...
              <td style="width:60%" ><div class="form-group" Style="margin-left:5px;margin-right:5px;">
                  ...
                  <input type="text" class="form-control" id="inputContactInfo0" name="inputContactInfo0" placeholder="Value" required >
                </div></td>
